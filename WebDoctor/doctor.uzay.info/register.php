...
<body>
    <div class="form-container">
        ...
        <form method="POST" action="" id="registerForm">
            ...
            <label for="information">Özel bir ilaç kullanıyormusunuz veya ciddi sağlık probleminiz var mı? Kullanıyorsanız/Varsa yazınız (255 karaktere kadar).</label>
            <textarea id="information" name="information" maxlength="255"></textarea><br>

            <div class="checkbox-group">
                <label><input type="checkbox" id="ibuprofen" name="condition[]" value="Ibuprofen'e karşı özel bir rahatsızlığım var.">
                    Ibuprofen'e karşı özel bir rahatsızlığım var.</label><br>
                <label><input type="checkbox" id="paracetamol" name="condition[]" value="Paracetemol'e karşı özel bir rahatsızlığım var.">
                    Paracetemol'e karşı özel bir rahatsızlığım var.</label><br>
                <label><input type="checkbox" id="gaviscon" name="condition[]" value="Gaviscon'a karşı özel bir rahatsızlığım var.">
                    Gaviscon'a karşı özel bir rahatsızlığım var.</label><br>
                <label><input type="checkbox" id="zyrtec" name="condition[]" value="Zyrtec'e karşı özel bir rahatsızlığım var.">
                    Zyrtec'e karşı özel bir rahatsızlığım var.</label><br>
                <label><input type="checkbox" id="allergic" name="condition[]" value="Bazı ilaçlara karşı aşırı alerijik reaksiyon gösteriyorum.">
